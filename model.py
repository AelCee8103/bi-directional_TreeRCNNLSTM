...
def main():
    ...
    # Load the GloVe matrix (comment out if you want to use custom fine-tuned embeddings instead)
    ...
    # Set pretrained_embeddings=torch.FloatTensor(custom_matrix) and freeze_embeddings=True in the model constructor when using the custom fine-tuned embeddings.
    
    # print("Loading custom fine-tuned embeddings...")
    # custom_matrix = np.load('emobank_custom_embeddings.npy')
    ...
    np.save('emobank_custom_embeddings.npy', adapted_matrix)
